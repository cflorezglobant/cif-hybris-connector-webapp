 ...
 */
@GraphQLObjectType("UpdateCartItemsOutput")
public class UpdateCartItemsOutput  {
	...
	public static class Builder {
		...
		public UpdateCartItemsOutput build() {
			UpdateCartItemsOutput _object = new UpdateCartItemsOutput();
