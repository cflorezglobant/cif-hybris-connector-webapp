 ...
 */
@GraphQLObjectType("VirtualProduct")
public class VirtualProduct implements ProductInterface, CustomizableProductInterface {
	...
	public static class Builder {
		...
		public VirtualProduct build() {
			VirtualProduct _object = new VirtualProduct();
