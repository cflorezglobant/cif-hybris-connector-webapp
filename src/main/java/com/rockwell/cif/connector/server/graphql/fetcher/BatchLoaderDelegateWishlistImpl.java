 ...
 * <PRE>
 * &#64;Override
 * public CompletableFuture<List<Wishlist>> friends(DataFetchingEnvironment environment, DataLoader<UUID, Wishlist> dataLoader,
 * 		Wishlist source) {
 ...
 */
@Component
public class BatchLoaderDelegateWishlistImpl implements BatchLoaderDelegate<UUID, Wishlist> {
	 ...
	 * @return the list of Wishlists corresponding to the given keys
	 */
	@Override
	public CompletionStage<List<Wishlist>> load(List<UUID> keys) {
		// We use supplyAsync() of values here for maximum parellisation
		return CompletableFuture.supplyAsync(() -> dataFetchersDelegateWishlist.batchLoader(keys));
	}
