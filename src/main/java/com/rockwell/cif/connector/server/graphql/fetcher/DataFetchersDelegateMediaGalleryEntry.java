 ...
 */
public interface DataFetchersDelegateMediaGalleryEntry {
	
	/**
	 * This method loads the data for MediaGalleryEntry.content. 
	 * <BR/>
	 * <BR/>
	 * 
	 ...
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the content attribute
	 *    of the <I>origin</I>, which is an instance of {MediaGalleryEntry}. It depends on your data modle, but it typically contains 
	...
	/**
	 * This method loads the data for MediaGalleryEntry.types. 
	 * <BR/>
	 * <BR/>
	 * 
	 * @param dataFetchingEnvironment 
	 *     The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full GraphQL context for this DataFetcher
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the types attribute
	 *    of the <I>origin</I>, which is an instance of {MediaGalleryEntry}. It depends on your data modle, but it typically contains 
	 *    the id to use in the query.
	 * @throws NoSuchElementException 
	 *     This method may return a {@link NoSuchElementException} exception. In this case, the exception is trapped 
	...
	/**
	 * This method loads the data for MediaGalleryEntry.video_content. 
	 * <BR/>
	 * <BR/>
	 * 
	 * @param dataFetchingEnvironment 
