 ...
 */
@GraphQLObjectType("CustomizableCheckboxValue")
public class CustomizableCheckboxValue  {
	...
	public static class Builder {
		...
		public CustomizableCheckboxValue build() {
			CustomizableCheckboxValue _object = new CustomizableCheckboxValue();
