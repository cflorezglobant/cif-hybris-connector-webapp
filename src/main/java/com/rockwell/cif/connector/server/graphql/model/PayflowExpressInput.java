 ...
 */
@GraphQLInputType("PayflowExpressInput")
public class PayflowExpressInput  {

	public PayflowExpressInput(){
		// No action
	}
	...
	public static class Builder {
		...
		public PayflowExpressInput build() {
			PayflowExpressInput _object = new PayflowExpressInput();
