 ...
 */
@GraphQLObjectType("CustomizableDropDownOption")
public class CustomizableDropDownOption implements CustomizableOptionInterface {
	...
	@GraphQLNonScalar(fieldName = "value", graphQLTypeName = "CustomizableDropDownValue", javaClass = CustomizableDropDownValue.class)
	List<CustomizableDropDownValue> value;
	...
	public void setValue(List<CustomizableDropDownValue> value) {
		this.value = value;
	}
	...
	public static class Builder {
		...
		private List<CustomizableDropDownValue> value;
		...
		public Builder withValue(List<CustomizableDropDownValue> value) {
			this.value = value;
			return this;
		}

		public CustomizableDropDownOption build() {
			CustomizableDropDownOption _object = new CustomizableDropDownOption();
