 ...
 */
@GraphQLObjectType("SendEmailToFriendRecipient")
public class SendEmailToFriendRecipient  {
	...
	public static class Builder {
		...
		public SendEmailToFriendRecipient build() {
			SendEmailToFriendRecipient _object = new SendEmailToFriendRecipient();
