 ...
 */
@GraphQLObjectType("RemoveCouponFromCartOutput")
public class RemoveCouponFromCartOutput  {
	...
	public static class Builder {
		...
		public RemoveCouponFromCartOutput build() {
			RemoveCouponFromCartOutput _object = new RemoveCouponFromCartOutput();
