 ...
 */
@GraphQLObjectType("CreatePayflowProTokenOutput")
public class CreatePayflowProTokenOutput  {
	...
	public static class Builder {
		...
		public CreatePayflowProTokenOutput build() {
			CreatePayflowProTokenOutput _object = new CreatePayflowProTokenOutput();
