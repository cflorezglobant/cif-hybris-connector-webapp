 ...
 */
public interface DataFetchersDelegateSwatchLayerFilterItemInterface {
	
	/**
	 * This method loads the data for SwatchLayerFilterItemInterface.swatch_data. 
	 * <BR/>
	 * <BR/>
	 * 
	 ...
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the swatch_data attribute
	 *    of the <I>origin</I>, which is an instance of {SwatchLayerFilterItemInterface}. It depends on your data modle, but it typically contains 
