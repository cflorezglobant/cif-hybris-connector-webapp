 ...
 */
@GraphQLInputType("CustomerAddressAttributeInput")
public class CustomerAddressAttributeInput  {

	public CustomerAddressAttributeInput(){
		// No action
	}
    ...
    public String toString() {
        return "CustomerAddressAttributeInput {"
	...
	public static class Builder {
		...
		public CustomerAddressAttributeInput build() {
			CustomerAddressAttributeInput _object = new CustomerAddressAttributeInput();
