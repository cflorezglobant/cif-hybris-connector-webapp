 ...
 */
@GraphQLObjectType("CustomizableDropDownValue")
public class CustomizableDropDownValue  {
	...
	public static class Builder {
		...
		public CustomizableDropDownValue build() {
			CustomizableDropDownValue _object = new CustomizableDropDownValue();
