 ...
 */
public interface DataFetchersDelegatePlaceOrderOutput {
	
	/**
	 * This method loads the data for PlaceOrderOutput.order. 
	 * <BR/>
	 * <BR/>
	 * 
	 ...
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the order attribute
	 *    of the <I>origin</I>, which is an instance of {PlaceOrderOutput}. It depends on your data modle, but it typically contains 
