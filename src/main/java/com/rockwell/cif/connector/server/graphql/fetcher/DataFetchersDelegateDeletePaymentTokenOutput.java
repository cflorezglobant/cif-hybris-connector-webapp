 ...
 */
public interface DataFetchersDelegateDeletePaymentTokenOutput {
	
	/**
	 * This method loads the data for DeletePaymentTokenOutput.customerPaymentTokens. 
	 * <BR/>
	 * <BR/>
	 * 
	 ...
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the customerPaymentTokens attribute
	 *    of the <I>origin</I>, which is an instance of {DeletePaymentTokenOutput}. It depends on your data modle, but it typically contains 
