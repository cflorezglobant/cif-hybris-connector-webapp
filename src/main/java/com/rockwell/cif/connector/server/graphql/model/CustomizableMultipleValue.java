 ...
 */
@GraphQLObjectType("CustomizableMultipleValue")
public class CustomizableMultipleValue  {
	...
	public static class Builder {
		...
		public CustomizableMultipleValue build() {
			CustomizableMultipleValue _object = new CustomizableMultipleValue();
