 ...
 */
@GraphQLObjectType("CustomizableMultipleOption")
public class CustomizableMultipleOption implements CustomizableOptionInterface {
	...
	@GraphQLNonScalar(fieldName = "value", graphQLTypeName = "CustomizableMultipleValue", javaClass = CustomizableMultipleValue.class)
	List<CustomizableMultipleValue> value;
	...
	public void setValue(List<CustomizableMultipleValue> value) {
		this.value = value;
	}
	...
	public static class Builder {
		...
		private List<CustomizableMultipleValue> value;
		...
		public Builder withValue(List<CustomizableMultipleValue> value) {
			this.value = value;
			return this;
		}

		public CustomizableMultipleOption build() {
			CustomizableMultipleOption _object = new CustomizableMultipleOption();
