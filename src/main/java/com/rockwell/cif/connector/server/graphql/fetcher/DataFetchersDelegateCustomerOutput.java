 ...
 */
public interface DataFetchersDelegateCustomerOutput {
	
	/**
	 * This method loads the data for CustomerOutput.customer. 
	 * <BR/>
	 * <BR/>
	 * 
	 ...
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the customer attribute
	 *    of the <I>origin</I>, which is an instance of {CustomerOutput}. It depends on your data modle, but it typically contains 
