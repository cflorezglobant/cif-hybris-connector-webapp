 ...
 */
public interface DataFetchersDelegateLayerFilter {
	
	/**
	 * This method loads the data for LayerFilter.filter_items. 
	 * <BR/>
	 * <BR/>
	 * 
	 ...
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the filter_items attribute
	 *    of the <I>origin</I>, which is an instance of {LayerFilter}. It depends on your data modle, but it typically contains 
