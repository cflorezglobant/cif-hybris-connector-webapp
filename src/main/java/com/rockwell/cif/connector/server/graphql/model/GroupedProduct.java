 ...
 */
@GraphQLObjectType("GroupedProduct")
public class GroupedProduct implements ProductInterface, PhysicalProductInterface {
	...
	@GraphQLNonScalar(fieldName = "items", graphQLTypeName = "GroupedProductItem", javaClass = GroupedProductItem.class)
	List<GroupedProductItem> items;
	...
	public void setItems(List<GroupedProductItem> items) {
		this.items = items;
	}
	...
	public static class Builder {
		...
		private List<GroupedProductItem> items;
		...
		public Builder withItems(List<GroupedProductItem> items) {
			this.items = items;
			return this;
		}
		...
		public GroupedProduct build() {
			GroupedProduct _object = new GroupedProduct();
