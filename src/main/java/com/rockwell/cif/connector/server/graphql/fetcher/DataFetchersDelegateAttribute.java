 ...
 */
public interface DataFetchersDelegateAttribute {
	
	/**
	 * This method loads the data for Attribute.attribute_options. 
	 * <BR/>
	 * <BR/>
	 * 
	 ...
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the attribute_options attribute
	 *    of the <I>origin</I>, which is an instance of {Attribute}. It depends on your data modle, but it typically contains 
