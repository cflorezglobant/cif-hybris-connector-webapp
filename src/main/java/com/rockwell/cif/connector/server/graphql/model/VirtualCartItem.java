 ...
 */
@GraphQLObjectType("VirtualCartItem")
public class VirtualCartItem implements CartItemInterface {
	...
	public static class Builder {
		...
		public VirtualCartItem build() {
			VirtualCartItem _object = new VirtualCartItem();
