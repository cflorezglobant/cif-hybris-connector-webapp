 ...
 */
@GraphQLObjectType("SetGuestEmailOnCartOutput")
public class SetGuestEmailOnCartOutput  {
	...
	public static class Builder {
		...
		public SetGuestEmailOnCartOutput build() {
			SetGuestEmailOnCartOutput _object = new SetGuestEmailOnCartOutput();
