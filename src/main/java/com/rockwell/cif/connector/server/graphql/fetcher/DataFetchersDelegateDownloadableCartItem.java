 ...
 */
public interface DataFetchersDelegateDownloadableCartItem {
	
	/**
	 * This method loads the data for DownloadableCartItem.customizable_options. 
	 * <BR/>
	 * <BR/>
	 * 
	 ...
	 *    of the <I>origin</I>, which is an instance of {DownloadableCartItem}. It depends on your data modle, but it typically contains 
	...
	/**
	 * This method loads the data for DownloadableCartItem.links. 
	 * <BR/>
	 * <BR/>
	 * 
	 * @param dataFetchingEnvironment 
	 *     The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full GraphQL context for this DataFetcher
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the links attribute
	 *    of the <I>origin</I>, which is an instance of {DownloadableCartItem}. It depends on your data modle, but it typically contains 
	 *    the id to use in the query.
	 * @throws NoSuchElementException 
	 *     This method may return a {@link NoSuchElementException} exception. In this case, the exception is trapped 
	...
	/**
	 * This method loads the data for DownloadableCartItem.prices. 
	 * <BR/>
	 * <BR/>
	 * 
	 * @param dataFetchingEnvironment 
	...
	/**
	 * This method loads the data for DownloadableCartItem.product. 
	 * <BR/>
	 * <BR/>
	 * 
	 * @param dataFetchingEnvironment 
	...
	/**
	 * This method loads the data for DownloadableCartItem.samples. 
	 * <BR/>
	 * <BR/>
	 * 
	 * @param dataFetchingEnvironment 
	 *     The GraphQL {@link DataFetchingEnvironment}. It gives you access to the full GraphQL context for this DataFetcher
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the samples attribute
	 *    of the <I>origin</I>, which is an instance of {DownloadableCartItem}. It depends on your data modle, but it typically contains 
	 *    the id to use in the query.
	 * @throws NoSuchElementException 
	 *     This method may return a {@link NoSuchElementException} exception. In this case, the exception is trapped 
