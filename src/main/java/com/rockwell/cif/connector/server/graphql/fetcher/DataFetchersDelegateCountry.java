 ...
 */
public interface DataFetchersDelegateCountry {
	
	/**
	 * This method loads the data for Country.available_regions. 
	 * <BR/>
	 * <BR/>
	 * 
	 ...
	 * @param origin 
	 *    The object from which the field is fetch. In other word: the aim of this data fetcher is to fetch the available_regions attribute
	 *    of the <I>origin</I>, which is an instance of {Country}. It depends on your data modle, but it typically contains 
