 ...
 * <PRE>
 * &#64;Override
 * public CompletableFuture<List<Cart>> friends(DataFetchingEnvironment environment, DataLoader<UUID, Cart> dataLoader,
 * 		Cart source) {
 ...
 */
@Component
public class BatchLoaderDelegateCartImpl implements BatchLoaderDelegate<UUID, Cart> {
	 ...
	 * @return the list of Carts corresponding to the given keys
	 */
	@Override
	public CompletionStage<List<Cart>> load(List<UUID> keys) {
		// We use supplyAsync() of values here for maximum parellisation
		return CompletableFuture.supplyAsync(() -> dataFetchersDelegateCart.batchLoader(keys));
	}
